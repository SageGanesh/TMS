...
public class VMS_Regression_Suite extends Base_Page_TMS {
	...
	public void report_flush() {
	 ...
	 /*
	  * Submit_Invoices(): This method is used to Submit the invoice.
	  * 
	  *  Steps:
	  *  1. Open the browser
...
//				"Submit the invoice by supplier")
//				.assignCategory("Submit the invoice");
...
//		
//		WebElement ele1= driver.findElement(By.xpath("//a[@href='/invoices']")); // //i[@class='bbx bx bx-detail ng-star-inserted']
//		ele1.click();
//		Thread.sleep(2000);
...
//		WebElement WorkOrder_drp = driver.findElement(By.xpath("/html/body/app-root/app-layout/app-vertical/div/div/div/app-new/div/div/div/form/div[1]/div/select"));
...
//		
//		//Implement select class for handling the dropdown
//		WebElement InvoiceType_drp = driver.findElement(By.xpath("/html/body/app-root/app-layout/app-vertical/div/div/div/app-new/div/div/div/form/div[2]/div[1]/select"));
...
//		
////		WebElement submit_btn=driver.findElement(By.xpath("//button[normalize-space()='Submit']")).click();
////		Thread.sleep(2000);
//		
...
//        String dynamicElementText = (String) ((JavascriptExecutor) driver).executeScript("return arguments[0].textContent;", dynamicElement);
//
...
//		  
//		  ExtentTest log = extent.createTest(
//					"Accept, In Process, Paid the Invoice by Accounts")
...
//	}
 ...
 @Test(priority=3, description
	  ...
	  ExtentTest log = extent.createTest(
				"Reject the invoice by Accounts")
				.assignCategory("Reject the invoice");
		System.out.println(log.getStatus());
		wait = new WebDriverWait(driver, Duration.ofSeconds(10));
      ...
      // Use JavaScriptExecutor to retrieve text of the element
      String reject_toast_text = (String) ((JavascriptExecutor) driver).executeScript("return arguments[0].textContent;", reject_toaster);
...
//	  
//	  ExtentTest log = extent.createTest(
//				"Resubmit the invoice by Supplier")
//				.assignCategory("Resubmit the invoice");
//		System.out.println(log.getStatus());
//		wait = new WebDriverWait(driver, Duration.ofSeconds(10));
//		
//		driver.findElement(By.xpath("//input[@id='email']")).sendKeys("automationsupplier@sageitinc.com");
